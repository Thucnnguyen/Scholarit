...
namespace Scholarit.Service.ServiceImp
{
    public class QuizAttempQuestionService : IQuizAttemptQuestionService
    {
        ...
        public QuizAttempQuestionService(IQuizAttemptQuestionRepo quizAttemptQuestionRepo, 
        ...
        {
            var existingQuizAttempt = await _repo.FindOneByCondition(qaq => qaq.QuizAttemptId == quizAttemptQuestion.QuizAttemptId && qaq.QuestionId == quizAttemptQuestion.QuestionId && !quizAttemptQuestion.IsDeleted && qaq.UserId == quizAttemptQuestion.UserId);
